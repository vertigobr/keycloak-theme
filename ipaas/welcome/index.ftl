...
<html>
<head>
    <title>Bem-vindo ao ${productNameFull}</title>
  ...
  <div class="row">
    <div class="col-sm-10 col-sm-offset-1 col-md-8 col-md-offset-2 col-lg-8 col-lg-offset-2">
      <div class="welcome-header">
        ...
        <h1>Bem-vindo ao <strong>${productNameFull}</strong></h1>
      </div>
      <div class="row">
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            ...
            <#elseif errorMessage?has_content>
                ...
                <h3><img src="welcome-content/user.png">Console Administrativo</h3>
            <#elseif bootstrap>
                <#if localUser>
                    <h3><img src="welcome-content/user.png">Console Administrativo</h3>
            ...
            <div class="welcome-primary-link">
              <h3><a href="${adminUrl}"><img src="welcome-content/user.png">Console Administrativo <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
              <div class="description">
                Gestão centralizada de tudo no serviço ${productNameFull}
              </div>
            </div>
          </div>
        </div>
        <div class="col-xs-12 col-sm-4">
          <div class="card-pf h-l">
            <h3><a href="${properties.documentationUrl}"><img class="doc-img" src="welcome-content/admin-console.png">Documentação <i class="fa fa-angle-right link" aria-hidden="true"></i></a></h3>
            <div class="description">

              Guia do Usuário, Admin REST API e Javadocs
